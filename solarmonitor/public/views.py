...
def oauth():
    ...
    return redirect("https://api.pge.com/datacustodian/test/oauth/v2/authorize?client_id=4f5e3635db834479a6a8ecc77da25407&redirect_uri=https://notrueup.solardatapros.com/pge-oauth-redirect&scope=1_3_4_5_8_13_14_15_18_19_31_32_35_37_38_39_40&response_type=code", code=302)
...
def oauth_redirect():
    ...
    current_user.pge_access_token = token_info.get('refresh_token', default=None)
    db.session.commit()

    session['current_access_token'] = token_info.get('access_token', default=None)
